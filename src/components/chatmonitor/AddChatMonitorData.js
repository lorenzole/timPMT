...
const AddChatMonitorData = () =>{
    ...
    const onSubmit = async e => {
      e.preventDefault();
      await axios.post(`${window.base}/chatmonitor/insert`, user);
    ...
    return (
      ...
      <Link className="btn btn-outline-dark" to="/chat-monitor">
        ...
        <h2 className="text-center mb-4">Add Configuration</h2>
  ...
  export default AddChatMonitorData;