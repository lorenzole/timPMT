...
const AddCodeStatMonitorData = () =>{
    ...
    const onSubmit = async e => {
      e.preventDefault();
      await axios.post(`${window.base}/codestatmonitor/insert`, user);
    ...
    return (
      ...
      <Link className="btn btn-outline-dark" to="/code-stat-monitor">
        ...
        <h2 className="text-center mb-4">Add Code Stat Monitor</h2>
        <form onSubmit={e => onSubmit(e)}>
          ...
          <button className="btn btn-primary btn-block">Add Code Stat Monitor</button>
        </form>
      </div>
    </div>
    );
  ...
  export default AddCodeStatMonitorData;